...
TimersWidget::TimersWidget() {
    ...
    addParam(createParam<BefacoTinyKnob>(Vec(Knob2_X, Knob2_Y), module, Timers::timer1_FINE, 0.0, 5.0, 0.0));
    ...
    addParam(createParam<BefacoTinyKnob>(Vec(Knob2_X, offset_Y + Knob2_Y), module, Timers::timer2_FINE, 0.0, 5.0, 0.0));
    ...
    addParam(createParam<BefacoTinyKnob>(Vec(Knob2_X, offset_Y + Knob2_Y), module, Timers::timer3_FINE, 0.0, 5.0, 0.0));
